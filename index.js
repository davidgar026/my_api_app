...
app.post("/", async (req, res) => {
    ...
    try {
        ...
        if (Array.isArray(selectedOptions)) { //if a user selects multiple genres(array) rather than one.
            ...
            What tf was I doing: I finished coding for when a user inputs multiple genres and inputs one selected genre. 

            What's next: Nothing, I've completed this project.
